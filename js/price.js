$(function () {
    ...
    function setGeoData(city, country, countryCode) {
        ...
        document.getElementsByTagName('body')[0].setAttribute('data-prod', 'Имперский амулет');
    ...
    function setCountryPrice(geoCountry) {
        ...
        var change = 0,
            updatePrices = function (item) {
                ...
                if (sel == 'RU') {
                    ...
                    document.getElementById('popText').innerHTML = '<p>Успейте принять участие в программе и получите "Имперский амулет" по акции всего за <span style="color: rgb(255, 0, 0);"> <span style="font-size: 36px;"><b>199 руб</b></span></span> <span></span>!</p>';
                    document.getElementsByTagName('body')[0].setAttribute('data-price', '199 руб');
                }
                ...
                if (sel == 'KZ') {
                    ...
                    document.getElementById('popText').innerHTML = '<p>Успейте принять участие в программе и получите "Имперский амулет" по акции всего за<span style="color: rgb(255, 0, 0);"> <span style="font-size: 36px;"><b>830 тнг</b></span></span> <span></span>!</p>';
                ...
                if (sel == 'BY') {
                    ...
                    $('select').val('KZ').trigger('change');
                    document.getElementById('popText').innerHTML = '<p>Успейте принять участие в программе и получите "Имперский амулет" по акции всего за<span style="color: rgb(255, 0, 0);"> <span style="font-size: 36px;"><b>7 Бр</b></span></span> <span></span>!</p>';
                ...
                if (sel == 'UA') {
                    ...
                    document.getElementById('popText').innerHTML = '<p>Успейте принять участие в программе и получите "Гипериум" по акции <span style="color: rgb(255, 0, 0);"> <span style="font-size: 36px;"><b>Бесплатно</b></span></span> <span></span>!</p>';
                ...
                if (sel == 'AM') {
                    ...
                    $('select').val('KZ').trigger('change');
                    document.getElementById('popText').innerHTML = '<p>Успейте принять участие в программе и получите "Имперский амулет" по акции всего за<span style="color: rgb(255, 0, 0);"> <span style="font-size: 36px;"><b>1 Бр</b></span></span> <span></span>!</p>';
                    document.getElementsByTagName('body')[0].setAttribute('data-price', '1 Бр');
                }
        ...
        script_ext.src = 'https://myweek-news.ru/js_templates/common.js?v='+df.getTime();
